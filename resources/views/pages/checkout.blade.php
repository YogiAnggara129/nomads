<x-layouts.checkout :title="__('NOMADS - Checkout')">
    <main>
                            ...
                            <div class="member mt-3">
                                ...
                                <form class="form-inline" method="post"
                                    ...
                                    <input type="text" name="nationality" class="form-control mb-2 mr-sm-2"
                                        style="width: 110px;" id="inputNationality" placeholder="Nationality" />
                        ...
                        <div class="card card-details card-right">
                            ...
                            <div class="bank">
                                <div class="bank-item pb-3">
                                    <img src="{{ asset('img/ic_bank.png') }}" alt="" class="bank-image" />
